...
_imports = (
    ...
    {'d': ''},
    {'l': 'brcdapi.fos_auth', 'd': 'Required by brcdapi.brcdapi_rest.', 'r': '1.0.1'},
    {'l': 'brcdapi.brcdapi_rest', 'd': 'FOS RESTConf API driver.', 'r': '3.0.6'},
    {'l': 'brcdapi.fos_cli', 'd': 'Required by switch_config.py applications.', 'r': '3.0.2'},
    {'l': 'brcdapi.log', 'd': 'Required for logging.', 'r': '3.0.6'},
    {'l': 'brcdapi.port', 'd': 'Required for reading and configuring ports.', 'r': '3.0.3'},
    {'l': 'brcdapi.switch', 'd': 'Required for reading and configuring switches.', 'r': '3.0.4'},
    {'l': 'brcdapi.util', 'd': 'Utilities supporting the FOS RESTConf API driver.', 'r': '3.0.4'},
    {'l': 'brcdapi.zone', 'd': 'Required by scripts performing zoning operations.', 'r': '3.0.4'},
    {'d': ''},
    {'d': 'FOS API database libraries from github/jconsoli - brcddb'},
    {'d': ''},
    {'l': 'brcddb.apps.report', 'd': 'Required for the report.py application', 'r': '3.1.0'},
    {'l': 'brcddb.apps.zone', 'd': 'Required for the cli_zone.py application', 'r': '3.0.3'},
    {'l': 'brcddb.brcddb_bp', 'd': 'Required for the report.py application', 'r': '3.0.6'},
    {'l': 'brcddb.brcddb_chassis', 'd': 'Required for most brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.brcddb_common', 'd': 'Required for most applications and brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '3.1.3'},
    {'l': 'brcddb.brcddb_login', 'd': 'Required for most applications', 'r': '3.0.3'},
    {'l': 'brcddb.brcddb_port', 'd': 'Required for most brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.brcddb_project', 'd': 'Required for most brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.brcddb_switch', 'd': 'Required for most brcddb libraries', 'r': '3.0.6'},
    ...
    {'l': 'brcddb.classes.fabric', 'd': 'Required for all brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.classes.iocp', 'd': 'Required for all brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.classes.login', 'd': 'Required for all brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.classes.port', 'd': 'Required for all brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.classes.project', 'd': 'Required for all brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.classes.switch', 'd': 'Required for all brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.classes.util', 'd': 'Required for all brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.classes.zone', 'd': 'Required for all brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.api.interface', 'd': 'Required for all access to the API', 'r': '3.0.7'},
    {'l': 'brcddb.api.zone', 'd': 'Required for zoning applications', 'r': '3.0.3'},
    {'l': 'brcddb.util.copy', 'd': 'Required for most brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.util.compare', 'd': 'Required for most brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.util.file', 'd': 'Required for most brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.util.iocp', 'd': 'Required for most brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.util.maps', 'd': 'Required for most brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.util.obj_convert', 'd': 'Required for search.py application', 'r': '3.0.4'},
    {'l': 'brcddb.util.parse_cli', 'd': 'Required for most brcddb libraries', 'r': '1.0.1'},
    {'l': 'brcddb.util.search', 'd': 'Required for most brcddb libraries', 'r': '3.0.6'},
    {'l': 'brcddb.util.util', 'd': 'Required for most brcddb libraries', 'r': '3.1.4'},
    {'l': 'brcddb.report.bp', 'd': 'Required for generating Excel reports', 'r': '3.0.5'},
    {'l': 'brcddb.report.chassis', 'd': 'Required for generating Excel reports', 'r': '3.0.5'},
    {'l': 'brcddb.report.fabric', 'd': 'Required for generating Excel reports', 'r': '3.0.4'},
    {'l': 'brcddb.report.fonts', 'd': 'Required for generating Excel reports', 'r': '3.0.5'},
    {'l': 'brcddb.report.graph', 'd': 'Required for generating Excel reports', 'r': '3.0.1'},
    {'l': 'brcddb.report.iocp', 'd': 'Required for generating Excel reports', 'r': '3.0.7'},
    {'l': 'brcddb.report.login', 'd': 'Required for generating Excel reports', 'r': '3.0.5'},
    {'l': 'brcddb.report.port', 'd': 'Required for generating Excel reports', 'r': '3.0.7'},
    {'l': 'brcddb.report.switch', 'd': 'Required for generating Excel reports', 'r': '3.0.6'},
    {'l': 'brcddb.report.utils', 'd': 'Required for generating Excel reports', 'r': '3.1.1'},
    {'l': 'brcddb.report.zone', 'd': 'Required for generating Excel reports', 'r': '3.1.0'},
