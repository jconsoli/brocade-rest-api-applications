...
+-----------+---------------+---------------------------------------------------------------------------------------+
| 4.0.8     | 20 Oct 2024   | Updated versions references.                                                          |
+-----------+---------------+---------------------------------------------------------------------------------------+
"""
...
_imports = (
    ...
    {'l': 'brcdapi.excel_util', 'd': 'Required by modules that read or write Excel workbooks', 'r': '4.0.4'},
    {'l': 'brcdapi.excel_fonts', 'd': 'Required by modules that read or write Excel workbooks', 'r': '4.0.2'},
    {'l': 'brcdapi.file', 'd': 'Required by modules that perform file I/O.', 'r': '4.0.4'},
    {'l': 'brcdapi.fos_cli', 'd': 'Required by modules that need CLI access.', 'r': '4.0.1'},
    {'l': 'brcdapi.gen_util', 'd': 'Required by most scripts.', 'r': '4.0.5'},
    ...
    {'l': 'brcdapi.util', 'd': 'Utilities supporting the FOS RESTConf API driver.', 'r': '4.0.3'},
    ...
    {'d': ''},
    {'l': 'brcddb.api.interface', 'd': 'Required for all access to the API', 'r': '4.0.2'},
    {'l': 'brcddb.api.zone', 'd': 'Required for zoning applications', 'r': '4.0.4'},
    {'l': 'brcddb.apps.report', 'd': 'Required for the report.py application', 'r': '4.0.2'},
    ...
    {'l': 'brcddb.brcddb_chassis', 'd': 'Required for most brcddb libraries', 'r': '4.0.3'},
    {'l': 'brcddb.brcddb_common', 'd': 'Required for most applications and brcddb libraries', 'r': '4.0.1'},
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '4.0.5'},
    {'l': 'brcddb.brcddb_login', 'd': 'Required for most applications', 'r': '4.0.2'},
    {'l': 'brcddb.brcddb_port', 'd': 'Required for most brcddb libraries', 'r': '4.0.2'},
    ...
    {'l': 'brcddb.classes.chassis', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    {'l': 'brcddb.classes.fabric', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    {'l': 'brcddb.classes.iocp', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    {'l': 'brcddb.classes.login', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    {'l': 'brcddb.classes.port', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    {'l': 'brcddb.classes.project', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    {'l': 'brcddb.classes.switch', 'd': 'Required for all brcddb libraries', 'r': '4.0.2'},
    ...
    {'l': 'brcddb.util.parse_cli', 'd': 'Required for most brcddb libraries', 'r': '4.0.4'},
    ...
    {'l': 'brcddb.report.chassis', 'd': 'Required for generating Excel reports', 'r': '4.0.3'},
    ...
    {'l': 'brcddb.report.utils', 'd': 'Required for generating Excel reports', 'r': '4.0.2'},
