...
imports = (
    ...
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '3.1.1'},
    ...
    {'l': 'brcddb.classes.fabric', 'd': 'Required for all brcddb libraries', 'r': '3.0.6'},
    ...
    {'l': 'brcddb.classes.project', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    ...
    {'l': 'brcddb.util.util', 'd': 'Required for most brcddb libraries', 'r': '3.1.2'},
