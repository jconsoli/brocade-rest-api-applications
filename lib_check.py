...
imports = (
    ...
    {'d': ''},
    {'l': 'brcddb.apps.report', 'd': 'Required for the report.py application', 'r': '3.0.6'},
    {'l': 'brcddb.apps.zone', 'd': 'Required for the cli_zone.py application', 'r': '3.0.1'},
    {'l': 'brcddb.brcddb_bp', 'd': 'Required for the report.py application', 'r': '3.0.4'},
    {'l': 'brcddb.brcddb_chassis', 'd': 'Required for most brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.brcddb_common', 'd': 'Required for most applications and brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.brcddb_login', 'd': 'Required for most applications', 'r': '3.0.2'},
    {'l': 'brcddb.brcddb_port', 'd': 'Required for most brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.brcddb_project', 'd': 'Required for most brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.brcddb_switch', 'd': 'Required for most brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.brcddb_zone', 'd': 'Required for most brcddb libraries', 'r': '3.0.2'},
    {'l': 'brcddb.classes.alert', 'd': 'Required for all brcddb libraries', 'r': '3.0.1'},
    {'l': 'brcddb.classes.chassis', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.classes.fabric', 'd': 'Required for all brcddb libraries', 'r': '3.0.3'},
    ...
    {'l': 'brcddb.classes.port', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    {'l': 'brcddb.classes.project', 'd': 'Required for all brcddb libraries', 'r': '3.0.3'},
    {'l': 'brcddb.classes.switch', 'd': 'Required for all brcddb libraries', 'r': '3.0.3'},
    {'l': 'brcddb.classes.util', 'd': 'Required for all brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.classes.zone', 'd': 'Required for all brcddb libraries', 'r': '3.0.4'},
    ...
    {'l': 'brcddb.report.iocp', 'd': 'Required for generating Excel reports', 'r': '3.0.3'},
