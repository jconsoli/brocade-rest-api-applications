...
_imports = (
    ...
    {'d': ''},
    {'l': 'brcdapi.fos_auth', 'd': 'Required by brcdapi.brcdapi_rest.', 'r': '1.0.2'},
    {'l': 'brcdapi.brcdapi_rest', 'd': 'FOS RESTConf API driver.', 'r': '3.0.7'},
    {'l': 'brcdapi.excel_util', 'd': 'Required by modules that read or write Excel workbooks', 'r': '1.0.0'},
    {'l': 'brcdapi.fos_cli', 'd': 'Required by switch_config.py applications.', 'r': '3.0.2'},
    {'l': 'brcdapi.file', 'd': 'Required by modules that perform file I/O.', 'r': '1.0.0'},
    {'l': 'brcdapi.gen_util', 'd': 'Required by most scripts.', 'r': '1.0.0'},
    {'l': 'brcdapi.log', 'd': 'Required by all scripts.', 'r': '3.0.7'},
    {'l': 'brcdapi.port', 'd': 'Required for reading and configuring ports.', 'r': '3.0.4'},
    {'l': 'brcdapi.switch', 'd': 'Required for reading and configuring switches.', 'r': '3.0.5'},
    {'l': 'brcdapi.util', 'd': 'Utilities supporting the FOS RESTConf API driver.', 'r': '3.0.5'},
    ...
    {'d': ''},
    {'l': 'brcddb.apps.report', 'd': 'Required for the report.py application', 'r': '3.1.1'},
    {'l': 'brcddb.apps.zone', 'd': 'Required for the cli_zone.py application', 'r': '3.0.4'},
    {'l': 'brcddb.brcddb_bp', 'd': 'Required for the report.py application', 'r': '3.0.7'},
    ...
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '3.1.4'},
    {'l': 'brcddb.brcddb_login', 'd': 'Required for most applications', 'r': '3.0.4'},
    {'l': 'brcddb.brcddb_port', 'd': 'Required for most brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.brcddb_project', 'd': 'Required for most brcddb libraries', 'r': '3.0.9'},
    ...
    {'l': 'brcddb.classes.switch', 'd': 'Required for all brcddb libraries', 'r': '3.0.7'},
    ...
    {'l': 'brcddb.api.zone', 'd': 'Required for zoning applications', 'r': '3.0.4'},
    {'l': 'brcddb.util.copy', 'd': 'Required for most brcddb libraries', 'r': '3.0.5'},
    {'l': 'brcddb.util.compare', 'd': 'Required for most brcddb libraries', 'r': '3.0.9'},
    ...
    {'l': 'brcddb.util.parse_cli', 'd': 'Required for most brcddb libraries', 'r': '1.0.2'},
    {'l': 'brcddb.util.search', 'd': 'Required for most brcddb libraries', 'r': '3.0.7'},
    {'l': 'brcddb.util.util', 'd': 'Required for most brcddb libraries', 'r': '3.1.5'},
    {'l': 'brcddb.report.bp', 'd': 'Required for generating Excel reports', 'r': '3.0.6'},
    {'l': 'brcddb.report.chassis', 'd': 'Required for generating Excel reports', 'r': '3.0.6'},
    {'l': 'brcddb.report.fabric', 'd': 'Required for generating Excel reports', 'r': '3.0.5'},
    {'l': 'brcddb.report.graph', 'd': 'Required for generating Excel reports', 'r': '3.0.2'},
    {'l': 'brcddb.report.iocp', 'd': 'Required for generating Excel reports', 'r': '3.0.8'},
    {'l': 'brcddb.report.login', 'd': 'Required for generating Excel reports', 'r': '3.0.6'},
    {'l': 'brcddb.report.port', 'd': 'Required for generating Excel reports', 'r': '3.0.8'},
    {'l': 'brcddb.report.switch', 'd': 'Required for generating Excel reports', 'r': '3.0.7'},
    {'l': 'brcddb.report.utils', 'd': 'Required for generating Excel reports', 'r': '3.1.2'},
    {'l': 'brcddb.report.zone', 'd': 'Required for generating Excel reports', 'r': '3.1.1'},
