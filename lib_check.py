...
Version Control::
    ...
    +-----------+---------------+-----------------------------------------------------------------------------------+
    | 3.2.1     | 25 Jul 2021   | Latest updates.                                                                   |
    +-----------+---------------+-----------------------------------------------------------------------------------+
"""
...
_imports = (
    ...
    {'l': 'brcdapi.gen_util', 'd': 'Required by most scripts.', 'r': '1.0.2'},
    ...
    {'l': 'brcdapi.util', 'd': 'Utilities supporting the FOS RESTConf API driver.', 'r': '3.0.7'},
    ...
    {'l': 'brcddb.brcddb_fabric', 'd': 'Required for most brcddb libraries', 'r': '3.1.6'},
    ...
    {'l': 'brcddb.util.search', 'd': 'Required for most brcddb libraries', 'r': '3.0.8'},
    {'l': 'brcddb.util.util', 'd': 'Required for most brcddb libraries', 'r': '3.1.6'},
    ...
    {'l': 'brcddb.report.login', 'd': 'Required for generating Excel reports', 'r': '3.0.7'},
    {'l': 'brcddb.report.port', 'd': 'Required for generating Excel reports', 'r': '3.0.9'},
    ...
    {'l': 'brcddb.report.zone', 'd': 'Required for generating Excel reports', 'r': '3.1.2'},
