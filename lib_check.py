...
_imports = (
    ...
    {'l': 'brcdapi.switch', 'd': 'Required for reading and configuring switches.', 'r': '3.0.7'},
    ...
    {'l': 'brcddb.brcddb_login', 'd': 'Required for most applications', 'r': '3.0.6'},
    {'l': 'brcddb.brcddb_port', 'd': 'Required for most brcddb libraries', 'r': '3.0.9'},
    {'l': 'brcddb.brcddb_project', 'd': 'Required for most brcddb libraries', 'r': '3.1.2'},
    ...
    {'l': 'brcddb.util.parse_cli', 'd': 'Required for most brcddb libraries', 'r': '1.0.5'},
    ...
    {'l': 'brcddb.report.utils', 'd': 'Required for generating Excel reports', 'r': '3.1.4'},
    {'l': 'brcddb.report.zone', 'd': 'Required for generating Excel reports', 'r': '3.1.4'},
