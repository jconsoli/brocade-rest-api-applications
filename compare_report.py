...
# -i test/test_output -b _capture_2024_01_12_06_30_39/combined -c '_capture_2024_01_21_16_11_32/combined' \
#     -r 'test/test_compare_report' -log _logs

# Input parameter definitions
_input_d = dict(
    b=dict(h='Required. Base project to compare against. Name of input file generated by capture.py or combine.py. '
             'Typically the older data.'),
    c=dict(h='Required. Project to compare against. Name of input file generated by capture.py or combine.py. '
             'Typically the newer data.'),
...
def _get_input():
    ...
    ml = ['compare_report.py:   ' + __version__,
