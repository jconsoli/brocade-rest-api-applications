...
_DEBUG_INF = 'WMG_8_Mar_2021/WMG_8_Mar_2021.json'
_DEBUG_OUTF = 'WMG_8_Mar_2021/test_report.xlsx'
_DEBUG_SUP = False
_DEBUG_SFP = None  # 'sfp_rules_r9.xlsx'
_DEBUG_IOCP = None  # 'SQA_IOCP'
...
def parse_args():
    ...
    :rtype: str
    """
    global _DEBUG_INF, _DEBUG_OUTF, _DEBUG_SFP, _DEBUG_SUP, _DEBUG_IOCP, _DEBUG_CR, _DEBUG_CA, _DEBUG_LOG, _DEBUG_NL

    if _DEBUG:
        return _DEBUG_INF, _DEBUG_OUTF, _DEBUG_SFP, _DEBUG_SUP, _DEBUG_IOCP, _DEBUG_CR, _DEBUG_CA, _DEBUG_LOG, _DEBUG_NL
    ...
    return args.inf, args.outf, args.sfp, args.sup, args.iocp, args.cr, args.ca, args.log, args.nl
...
def psuedo_main():
    ...
    inf, outf, sfp_rules, s_flag, iocp, cr, ca, log, nl = parse_args()
    if not nl:
    ...
    if sfp_rules is None:
        ...
        if len(sfp_rules) < len('.xlsx') or sfp_rules[len(outf)-len('.xlsx'):] != '.xlsx':
    ...
    for file in brcddb_file.read_director(iocp):
