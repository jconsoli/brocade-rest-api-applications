#!/usr/bin/python
# -*- coding: utf-8 -*-
# Copyright 2023 Jack Consoli, Inc.  All rights reserved.
#
...
Version Control::
    ...
    +-----------+---------------+-----------------------------------------------------------------------------------+
    | 1.0.1     | 06 Jun 2023   | Documentation updates.                                                            |
    +-----------+---------------+-----------------------------------------------------------------------------------+
    | 1.0.2     | xx Jun 2023   | Made port enable persistent for FICON logical switches.                           |
    +-----------+---------------+-----------------------------------------------------------------------------------+
"""
